...
This means saved recipes stay on the same device and browser. They are not synced or uploaded anywhere.
...
- There is no import or export flow for sharing recipes between devices.
